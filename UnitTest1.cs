using IndianStateCensusAnalyze;
using IndianStateCensusAnalyze.DTO;
using NUnit.Framework;
using System.Collections.Generic;
using static IndianStateCensusAnalyze.CensusAnalyser;
...
namespace CensualAnalyserTest
{
    public class Tests
    {
        ...
        static string indianStateCensusFilePath = @"C:\Users\user\source\repos\IndianStateCensusAnalyze\CensualAnalyserTest\CsvFiles\IndiaStateCensusData.csv";
        static string wrongHeaderIndianCensusFilePath = @"C:\Users\user\source\repos\IndianStateCensusAnalyze\CensualAnalyserTest\CsvFiles\WrongIndiaStateCensusData.csv";
        static string delimiterIndianCensusFilePath = @"C:\Users\user\source\repos\IndianStateCensusAnalyze\CensualAnalyserTest\CsvFiles\DelimiterIndiaStateCensusData.csv";
        static string wrongIndianStateCensusFilePath = @"C:\Users\user\source\repos\IndianStateCensusAnalyze\CensualAnalyserTest\CsvFiles\WrongIndiaStateCensusData.csv";
        ...
        static string indianStateCodeFilePath = @"C:\Users\user\source\repos\IndianStateCensusAnalyze\CensualAnalyserTest\CsvFiles\IndiaStateCode.csv";
        ...
        static string delimiterIndianStateCodeFilePath = @"C:\Users\user\source\repos\IndianStateCensusAnalyze\CensualAnalyserTest\CsvFiles\DelimiterIndiaStateCode.csv";
        static string wrongHeaderStateCodeFilePath = @"C:\Users\user\source\repos\IndianStateCensusAnalyze\CensualAnalyserTest\CsvFiles\WrongIndiaStateCode.csv";
        //US Census FilePath
